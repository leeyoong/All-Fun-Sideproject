...
public class CreateBoardRequestDto {
    ...
    public CreateBoardRequestDto(String title, String content, int backend, int frontend, int pm, int android, int iOS, int ai, int bigData, int blockChain, LocalDateTime endDate) {
        this.title = title;
        this.content = content;
        this.backend = backend;
        this.frontend = frontend;
