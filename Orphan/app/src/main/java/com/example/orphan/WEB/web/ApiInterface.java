...
// 여기 미구현 시팔 개어렵네 (*이융 참조)
    ...
    Call<GroupBoardDetailDto> board_PATCH_groupBoardDetail(@Path("groupBoardId")Long groupBoardId,
...
// ToDoController  ("/dashboard/{groupId}/todo")
    ...
    Call<OneItemDto> ToDoController_POST_create(@Path("groupId")Long groupId, @Body CreateToDoDto request);
...
//MatchingBoardController  ("/board")
    ...
    Call<List<SearchResponseDto>> MatchingBoardController_GET_listRecently(@Path("filter") String filter);
