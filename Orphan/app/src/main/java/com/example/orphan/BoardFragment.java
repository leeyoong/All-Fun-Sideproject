...
public class BoardFragment extends Fragment {
    ...
    public static void setListViewHeightBasedOnChildren(ListView listView) {
        ...
        for (int i = 0; i < listAdapter.getCount(); i++) {
            ...
            totalHeight += (listAdapter.getCount() * 8);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for (GroupBoardListDto groupBoardListDto : other) {
            ...
            adapter.addItem(groupBoardListDto.getTitle(), groupBoardListDto.getKinds().toUpperCase(),
                    groupBoardListDto.getCreatedDate().substring(0,10),
                    groupBoardListDto.getMemberNickname(),
                    groupBoardListDto.getGroupBoardId(),
                    memberid
            );
        }
