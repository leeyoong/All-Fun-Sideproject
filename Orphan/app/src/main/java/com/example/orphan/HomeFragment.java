...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView mypagebt = (ImageView) view.findViewById(R.id.mypagebt);
        ...
        listView2 = (ListView) view.findViewById(R.id.recentview);
        listView2.setAdapter(adapter2);

        for (MyGroupBoardDto dto : GroupBoardList) {
            adapter2.addItem(dto.getGroupName(), dto.getTitle());
        }
